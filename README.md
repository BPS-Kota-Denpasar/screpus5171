...
3. Jika berhasil, selanjutnya Double click start\_screp.bat
4. Tunggu sampai selesai
5. Script sudah otomatis akan melakukan update file test.xlsx 



Note : 
Contoh output sudah ada seperti di file test\_CONTOH\_OUTPUT.xlsx
